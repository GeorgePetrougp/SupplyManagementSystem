...
namespace SupplyMS.Plugins.EFCore.Migrations
{
    ...
    [Migration("20230927132259_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupplyMS.Domain.Inventory", b =>
                {
            ...
            modelBuilder.Entity("SupplyMS.Domain.InventoryTransaction", b =>
                {
            ...
            modelBuilder.Entity("SupplyMS.Domain.Product", b =>
                {
            ...
            modelBuilder.Entity("SupplyMS.Domain.ProductInventory", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SupplyMS.Domain.ProductTransaction", b =>
                {
            ...
            modelBuilder.Entity("SupplyMS.Domain.InventoryTransaction", b =>
                {
                    b.HasOne("SupplyMS.Domain.Inventory", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("SupplyMS.Domain.ProductInventory", b =>
                {
                    ...
                    b.HasOne("SupplyMS.Domain.Product", "Product")
                        .WithMany("ProductInventories")
